...
public class Contains extends FunctionBase2 {
	...
	public NodeValue exec(NodeValue v,NodeValue v1) {
		...
		if(wrapper1 instanceof GeometryWrapper && wrapper2 instanceof GeometryWrapper) {
	        ...
	        return NodeValue.makeBoolean(LiteralUtils.toGeometry(bbox1.getBounds()).contains(JTS.toGeometry(bbox2.getBounds())));			
		}else {
			if(wrapper1 instanceof CoverageWrapper) {
				...
				return NodeValue.makeBoolean(geom.contains(JTS.toGeometry(bbox1.getBounds())));				
			}
		}
	}
