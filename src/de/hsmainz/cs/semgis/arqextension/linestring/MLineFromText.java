	...
	public NodeValue exec(NodeValue arg0, NodeValue arg1) {
        try {
            ...
            if("MULTILINESTRING".equals(geom.getGeometryType().toUpperCase())){
            	GeometryWrapper pointWrapper = GeometryWrapper.createGeometry(geom, "<http://www.opengis.net/def/crs/EPSG/0/"+srid!=null?srid.toString():geom.getSRID()+">", WKTDatatype.URI);	
